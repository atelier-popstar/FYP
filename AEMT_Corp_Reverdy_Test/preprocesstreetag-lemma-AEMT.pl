...
open (OUT, ">Dialogue/aemt01/AnalysisLemma/aemt01-lemma");
...
#AEMT aemt02
    ...
    #The tagger's input text is stored in a file.
    $file_path = 'Corpus/CorpusWithoutTab/aemt02.txt';
    ...
    # as raw text...
    #Print into a file
    open ($fh, '>', 'CorporaTagged/aemt02.Tag.txt');
...
open (OUT, ">Dialogue/aemt02/AnalysisLemma/aemt02-lemma");
